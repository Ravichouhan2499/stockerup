...
export default function Privacy() {
  return (
    ...
    <div className="terms-section-1">
      <h2 className="terms-subtitle">Sharing</h2>
    ...
    <div className="terms-section-1">
      <h2 className="terms-subtitle">security precautions</h2>
    ...
    <div className="terms-section-1">
      <h2 className="terms-subtitle">Data Deletion and Retention</h2>
    ...
    <div className="terms-section-1">
      <h2 className="terms-subtitle">Your Right</h2>
     
      <p>
      You may access, rectify, and update your personal data directly through the functionalities provided on the Platform    </p>
    </div>


    <div className="terms-section-1">
      <h2 className="terms-subtitle">Consent</h2>
    ...
    <div className="terms-section-1">
      ...
      <p>
      Please check our Privacy Policy periodically for changes. We may update this Privacy Policy to reflect changes to our information practices. We may alert / notify you about the significant changes to the Privacy Policy, in the manner as may be required under applicable laws.      </p>
    </div>

    <div className="terms-section-1">
      <h2 className="terms-subtitle">GRIEVANCE OFFICER</h2>
      <p> <b>Shiv Prakash Tiwari</b></p>
      <p>Designation :       </p>


      <p> <b>Shiv Prakash Tiwari</b></p>
      <p> <b>D 206 BRAVE HEART RAJ NAGAR EXTENSION GHAZIABAD UP 201017, Ghaziabad ,India</b></p>   
    
      <p><b>Contact Us:</b><Link style={{ textDecoration: 'none' }} to='mailto:cpfasurya2@gmail.com'>&nbsp; &nbsp;cpfasurya2@gmail.com</Link> </p>
